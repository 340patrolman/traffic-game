...
var FILES = [
  ...
  './js/terrain.js' + V, './js/weather.js' + V, './js/signals.js' + V, './js/vehmesh.js' + V, './js/vehicle.js' + V, './js/traffic.js' + V, './js/peds.js' + V, './js/character.js' + V, './js/vfx.js' + V, './js/response.js' + V, './js/junction.js' + V, './js/chase.js' + V, './js/intro.js' + V, './js/walker.js' + V, './js/qr.js' + V, './promo.html' + V, './js/promo.js' + V, './js/rail.js' + V, './js/enforcement.js' + V, './js/study.js' + V, './js/drunkproc.js' + V, './js/facil.js' + V, './js/layers.js' + V, './data/taas.json', './data/maps/index.json', './data/maps/seocho.json', './data/taas-nodes-seocho.json', './data/taas-fatal-seocho.json', './data/taas-vuln-seocho.json',
