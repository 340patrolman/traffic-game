...
var FILES = [
  ...
  './js/config.js' + V, './js/rng.js' + V, './js/save.js' + V, './js/perf.js' + V, './js/emblem.js' + V, './js/humans-data.js' + V, './js/humans.js' + V, './js/textures.js' + V, './js/audio.js' + V, './js/city.js' + V, './js/world.js' + V,
  './js/terrain.js' + V, './js/weather.js' + V, './js/signals.js' + V, './js/vehmesh.js' + V, './js/patrolev.js' + V, './js/vehicle.js' + V, './js/traffic.js' + V, './js/peds.js' + V, './js/character.js' + V, './js/vfx.js' + V, './js/response.js' + V, './js/junction.js' + V, './js/chase.js' + V, './js/incident.js' + V, './js/dispatch.js' + V, './js/intro.js' + V, './js/walker.js' + V, './js/qr.js' + V, './promo.html' + V, './js/promo.js' + V, './js/rail.js' + V, './js/enforcement.js' + V, './js/study.js' + V, './js/drunkproc.js' + V, './js/kidcourse.js' + V, './js/tot.js' + V, './js/bike.js' + V, './js/career.js' + V, './js/praise.js' + V, './js/replay.js' + V, './js/stopcam.js' + V, './js/firstshift.js' + V, './js/crew.js' + V, './js/campaign.js' + V, './js/story.js' + V, './js/signaltod.js' + V, './js/facil.js' + V, './js/layers.js' + V, './data/taas.json', './data/signal-tod-seocho.json', './data/maps/index.json', './data/maps/seocho.json', './data/maps/seocho-twin.json', './data/maps/seocho-twin-roads.json', './data/taas-nodes-seocho.json', './data/taas-fatal-seocho.json', './data/taas-vuln-seocho.json',
