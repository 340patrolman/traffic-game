...
window.TG = window.TG || {};
TG.VERSION = '0.10.31';   // 화면(타이틀 · 일시정지)과 콘솔에 그대로 나온다. 판올림 때 index.html·promo.html 의 ?v= 와 sw.js 의 CACHE·FILES 도 같이 올린다
TG.CONFIG = {
  SEED: 340,
  ...
  // --- 플레이어 차량 ---
  // 제원·물리는 **data/units.js 한 곳**에서 온다(ROADMAP B1 — 차량 선택 카드와 물리가 같은 값을 쓴다). 여기에 숫자를 다시 적지 않는다.
  CARS: TG.UNITS.cars(),
